...
module datapath(
    ...
    input rst,
    output halt,           // [S?A L?I] Ph?i là OUTPUT
    output [15:0] current_pc,       
    
    // Các Port giao ti?p I/O Memory-Mapped
    ...
    // ==========================================
    // MAP GIAO TI?P RA NGOÀI CPU_TOP
    // ==========================================
    ...
    control_unit ctrl_unit (
        ...
        .Halt(Ctrl_Halt)         // <--- ?Ã N?I DÂY HALT
    );

    register_file reg_file (
        .clk(clk), 
        .ce(ce),                 // <--- THÊM CE ?? ??NG B? GHI
        .rst(rst),
